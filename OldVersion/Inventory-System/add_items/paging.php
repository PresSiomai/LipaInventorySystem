      <i style='  float:left; margin-top:20px;' >Page <?php echo $page_no." of ".$total_no_of_pages; ?></i>
      <ul class="pagination pagination-sm" style="margin-top:30px; justify-content: flex-end;">

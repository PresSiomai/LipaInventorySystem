...
$result_count = mysqli_query($con,"SELECT COUNT(*) As id FROM `tbl_archive`");
    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <section class="content" style="width:98%; margin-left: 1%; margin-right: 1%; font-family: Poppins; ">
          <div>
            <h5 style="font-family: Poppins; color:#afafaf; margin-bottom: 20px; margin-top: 20px; margin-left:4px;">Total Items Value: &nbsp;<a style="color: #10bc2d; font-size: 30px;">201,219</a></h5>
              ...
              <div class="col-12" >
                ...
                <div class="card" style="background-color: #f9f9f9;">
                  ...
                  <div class="card-body" >
                    ...
                    $sql = "SELECT * FROM tbl_archive ORDER BY id DESC LIMIT $offset, $total_records_per_page ";
                    ...
                    while($row = mysqli_fetch_array($res_data)){
                      ...
                      <tbody style="color:#626867; text-align: center;" id="tableInfo">
                        ...
                        <tr>
                          ...
                          <td>
                            <form action="../unserviseable-history" method="GET">

...
<div class="modal fade" id="edit-file<?php echo $ItemCode; ?>">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-success" name="btn_edit_item_archive">Save changes</button>
          </div>
        </div>
      </div>
    </div>
 ...
 <form method="POST" accept-charset="UTF-8">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-success" name="btn_retrieve">Confirm Password</button>
      </div>
  ...
  <form method="POST" accept-charset="UTF-8">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-success" name="btn_update_item_history_archive">Save changes</button>
        </div>
      </div>
    </div>
  </form>
